...
select_df['射出最前進位置[mm]しきい値'] = 2.60
select_df['V-P切換圧[MPa]しきい値'] = 50.0
...
line.x_axis.title = '射出最前進位置のしきい値は「モモイロ：2.60mm」　これ以上はショートリスク有り！'
...
line2.x_axis.title = 'VP切替圧のしきい値は「モモイロ:50.0Mpa」　これ以下はショートリスク有り！'
